...
const assignBuddySchema = z.object({
  ...
  messageForBuddy: z.string().describe('A message to send to the buddy, telling them when and where to meet Joe and your conversation partner, and whether they will walk with Joe before or after. This note should be polite, start with a greeting, and ask them if the match is okay with them. Tell them both walks are 15 minutes.'),
})
